<template>
	<view class="content">
		<view class="head">
			<!-- 背景 -->
			<view class="">
				<image src="../../static/ic0-bj.jpg" class="bejin"></image>
			</view>
			<!-- 用户 -->
			<view class="user">
				<view class="user-t">
				...
				<view class="user-b">
					...
					<view class="titles sucn">
						...
						<view class="grade"  v-show="loginBool"><span class="iconfont icos">&#xe630;</span>一星会员</view>
					</view>
				</view>
			</view>
			<!-- 设置分区 -->
...
<style>
	...
	.user{
		...
		background: #FFFFFF;
		border-radius: 40upx;
		background-image: url(../../static/ico-vip.png);
